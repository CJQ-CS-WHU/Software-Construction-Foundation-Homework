...
namespace OrderForm {
  public partial class FormMain : Form {
    ...
    public FormMain() {
      ...
      /*
      Order order = new Order(3, new Customer("10", "li"), new List<OrderItem>());
      order.AddItem(new OrderItem(1, new Goods("100", "apple", 100.0), 10));
      orderService.AddOrder(order);
      Order order2 = new Order(4, new Customer("298", "zhang"), new List<OrderItem>());
      order2.AddItem(new OrderItem(166, new Goods("26", "egg", 200.0), 10));
